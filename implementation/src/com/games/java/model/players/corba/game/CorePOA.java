...
/**
* com/games/java/model/players/corba/game/CorePOA.java .
...
public abstract class CorePOA extends org.omg.PortableServer.Servant
 implements com.games.java.model.players.corba.game.CoreOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       {
         com.games.java.model.players.corba.game.SizeCore $result = null;
         $result = this.getSize ();
         out = $rh.createReply();
         com.games.java.model.players.corba.game.SizeCoreHelper.write (out, $result);
         break;
       }

       case 1:  // game/Core/setSize
       {
         com.games.java.model.players.corba.game.SizeCore size = com.games.java.model.players.corba.game.SizeCoreHelper.read (in);
         this.setSize (size);
         out = $rh.createReply();
         break;
       }
       ...
       {
         com.games.java.model.players.corba.game.Point2D $result = null;
         $result = this.getLocation ();
         out = $rh.createReply();
         com.games.java.model.players.corba.game.Point2DHelper.write (out, $result);
         break;
       }

       case 3:  // game/Core/setLocation
       {
         com.games.java.model.players.corba.game.Point2D location = com.games.java.model.players.corba.game.Point2DHelper.read (in);
       ...
       {
         com.games.java.model.players.corba.game.Core sourceCore = com.games.java.model.players.corba.game.CoreHelper.read (in);
