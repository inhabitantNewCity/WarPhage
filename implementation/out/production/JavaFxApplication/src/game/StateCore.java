...
public class StateCore implements org.omg.CORBA.portable.IDLEntity
{
  ...
  private static game.StateCore[] __array = new game.StateCore [__size];

  public static final int _RED = 0;
  public static final game.StateCore RED = new game.StateCore(_RED);
  public static final int _GREEN = 1;
  public static final game.StateCore GREEN = new game.StateCore(_GREEN);
  public static final int _BLACK = 2;
  public static final game.StateCore BLACK = new game.StateCore(_BLACK);
  ...
  public static game.StateCore from_int (int value)
  {
